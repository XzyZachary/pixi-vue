...
export default class MainScene extends Scene {
    constructor(game) {
        ...
        this.stageContainer.sortChildren = true
    ...
    update(delta) {
        ...
        if (!this.isStart || this.hidCount >= this.createCount) return;
        ...
        Bus.$emit('sendBullet', {
            ...
            callback: async duck => {
                ...
                if (this.hitList[duck.dIndex]) {
                    this.hitLit[duck.dIndex + 1] = true
                } else {
    ...
    async createDuck() {
        ...
        for (let i = 0; i < createCount; i++) {
            const duck = new Duck({
                ...
                x: random(80, game.width - 100),
                y: random(50, game.height - 100),
                speed: 3 + this.round,
