import { showScore, createSprite, wait } from "./tools"
...
export default class Duck {
    ...
    die() {
        ...
        sprite.width = getTextures('duct_10').width
        sprite.height = getTextures('duct_10').height
